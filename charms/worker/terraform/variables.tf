...
variable "base" {
  ...
  validation {
    condition     = contains(["ubuntu@20.04", "ubuntu@22.04", "ubuntu@24.04", "ubuntu@26.04"], var.base)
    error_message = "Base must be one of ubuntu@20.04, ubuntu@22.04, ubuntu@24.04, ubuntu@26.04"
  }
}
